...
const DogHome = ({ navigation }) => {
  ...
  const editForm = (index) => {
    ...
    navigation.navigate('CadastroDog', {
      formToEdit,
  ...
  const addNewForm = () => {
    navigation.navigate('CadastroDog', { onSave: saveForm });
  };
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <View style={styles.formContainer}>
            ...
            <Text>Idade: {item.sexo}</Text>
            <Text>Idade: {item.origem}</Text>
